...
const initialHistoryList = [
  {
    ...
    logoUrl: 'https://assets.ccbp.in/frontend/reacr-js/instagram-img.png',
    title: 'Instagram',
  ...
  },
  {
    ...
    title: 'Twitter. Its whats happening / Twitter',
    ...
    return (
      <>
        <div className="header-container">
          <img
            src="https://assets.ccbp.in/frontend/react-js/website-logo.png"
            alt="app logo"
            className="logo"
          />
